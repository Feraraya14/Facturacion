...
public class Factura {
    ...
    public Factura(String numeroFactura, Date fecha, Cliente cliente, Vendedor vendedor, String tipoDePago, Integer descuento, Double subTotal, Double totalDescuento, Double totalIva, String observacion, Short anulado, Double pagoInicial) {
    ...
    public Factura(String numeroFactura, Date fecha, String tipoDePago, Integer descuento, Double subTotal, Double totalDescuento, Double totalIva, String observacion, Short anulado, Double pagoInicial) {
        this.numeroFactura = numeroFactura;
        this.fecha = fecha;
        this.tipoDePago = tipoDePago;
        this.descuento = descuento;
    ...
    public Factura(String numeroFactura, Date fecha, String tipoDePago, Integer descuento, Double subTotal, Double totalDescuento, Double totalIva, Short anulado) {
        this.numeroFactura = numeroFactura;
        this.fecha = fecha;
        this.tipoDePago = tipoDePago;
        this.descuento = descuento;
